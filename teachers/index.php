...
$sql = " SELECT teachers.*, courses.name as course_name FROM teachers 
            INNER JOIN courses ON courses.id = teachers.course_id";
            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        <table id="datatablesSimple">
                              ...
                              <tbody>
                                    <?php while ($teacher = $result->fetch_object()) { ?>
                                          <tr>
                                                <td><?php echo $i++ ?></td>
                                                ...
                                                <td><?php echo ($teacher->status == 0) ? ' <i class="fa-solid fa-circle-xmark fa-xl" style="color: #f50000;"></i>'  :  '<i class="fa-solid fa-circle-check fa-xl" style="color: #006af5;"></i> ' ?></td>
                                                <td>
                                                <a href="edit.php ? id=<?php echo $teacher ->id?>"><i class="fa-solid fa-gear fa-xl" style="color: #0190e9;"></i></button></a>
                                                </td>
                                          </tr>
                                    <?php } ?>
                              </tbody>
...
include(ROOT_PATH . '/teachers/create.php');
