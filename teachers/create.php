                  ...
                  <div class="modal-body">
                        <form action="action_save.php" method="post">
                              ...
                              <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter First Name " required>
                              </div>
                              ...
                              <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter Gamil" required>
                              </div>
